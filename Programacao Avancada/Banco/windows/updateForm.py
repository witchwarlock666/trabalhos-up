...
class UpdateForm:
    def __init__(self, id, usuario, db, master=None):
    ...
    def confirm(self):
        ...
        Game.updateGame(self.db, self.id, title, developer, publisher, release)
        
        Log.createLog(self.db, "User " + self.usuario.usuario + " Updated Game " + title)
